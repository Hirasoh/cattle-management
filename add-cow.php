 ...
 <div class="w3-row">
 	...
 	<div class="col-md-6">
      ...
      if(isset($_POST['submit']))
      {
      	...
      	$insert = $db->query("INSERT INTO cows(cowno,weight,arrived,breed_id,remark,health_status,img,gender) VALUES('$n_cowno','$n_weight','$n_arrived','$n_breed','$n_remark','$n_status','$path1','$n_gender') ");
       ...
       <?php
          ...
          <div class="alert alert-danger alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Error creatiing cow data. Please try again <i class="fa fa-times"></i></strong>
        </div>
      	<?php
      }
     ...
     ?>
 		<form method="post" autocomplete="off" enctype="multipart/form-data">
 			<div class="form-group">
	 			...
	 			<input type="text" name="cowno" class="form-control" value="cow-fms-<?php echo mt_rand(0000,9999); ?>" readonly="on" required>
	 		</div>
	 		...
	 		<div class="form-group">
	 			<label class="control-label">cow photo</label>
