 ...
 <div class="w3-container" style="padding-top:22px">
     ...
     <?php
      if(isset($_POST['submit']))
      {
      	...
      	$insert_query = $db->query("INSERT INTO quarantine(cow_no,breed,reason,date_q)VALUES('$n_cowno','$n_breed','$n_remark','$now') ");

      	if($insert_query){?>
      	<div class="alert alert-success alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>cow successfully quarantined <i class="fa fa-check"></i></strong>
        </div>
       <?php
         header('refresh: 5');
      	}else{ ?>
          <div class="alert alert-danger alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Error inserting cow data. Please try again <i class="fa fa-times"></i></strong>
        </div>
      	<?php
      }
     ...
     ?>
	 		...
	 		<form role='form' method="post">
	 			<div class="form-group">
	 				...
	 				<input type="text" name="cowno" readonly="on" class="form-control" value="<?php echo $cowno; ?>">
	 			</div>
