...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-row">
 	<h2>Manage cows</h2>
  <a href="add-cow.php" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus"></i> Add New cow</a><br><br>
            ...
            <td>
               <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="edit-cow.php?id=<?php echo $data->id ?>"><i class="fa fa-edit"></i> Edit</a></li>
